...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("Hi! Welcome to the Komal's Casino, What is your name?");
        ...
        while (cash > 0) {
            ...
            } else if (dealer.hasBlackJack())//check if the dealer has blackjack.
            {
                ...
                {
                    System.out.println("Would you like to double down? Yes/No");//allows the user to double down.
            ...
            System.out.println("Would you like to play again? Yes/No");//ask if the user wants to keep going
        ...
        if (cash == 0) {
            System.out.println("Sorry!!!You ran out of cash!!! Please try your luck next time!!!");
        } else {
            System.out.println("Congratulations!!! You Won!!! Enjoy your winnings, " + name + "!");
        }
    }
    ...
    public static int Bet(int cash) {
        ...
        int bet = sc.nextInt();
        while (bet > cash) {
            System.out.println("You cannot bet more than the cash you have!!!");
            System.out.println("How much would you like to bet?");
            bet = sc.nextInt();
        }
        return bet;
